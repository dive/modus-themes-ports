...
- `scripts/render-ghostty-themes.sh`: render `ports/ghostty/themes/*`
- `scripts/render-lazygit-themes.sh`: render `ports/lazygit/themes/*`
- `scripts/install-modus.sh`: install, uninstall, list themes
- `scripts/validate-ghostty-themes.sh`: validate Ghostty theme files
- `scripts/validate-lazygit-themes.sh`: validate Lazygit theme files
